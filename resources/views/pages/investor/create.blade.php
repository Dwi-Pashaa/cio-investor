                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="bussines_funds" id="bussines_funds" class="form-control @error('bussines_funds') is-invalid @enderror" value="{{ old('bussines_funds') }}">
                    ...
                    <div class="col-lg-6 mb-1">
                        <div class="form-group mb-2">
                            ...
                            <input type="text" name="persentase" id="persentase" class="form-control @error('persentase') is-invalid @enderror" value="{{ old('persentase') }}">
                            @error('persentase')
                                <span class="invalid-feedback">
                                    {{ $message }}
                                </span>
...
@push('js')
    <script>
        ...
        $("#bussines_funds").keyup(function() {
            let value = $(this).val();

            $("#bussines_funds").val(formatRupiah(value))
        });
    </script>
@endpush