...
@php
    ...
    $groupedPermissions = [
        ...
        'Data Investor' => [
            ...
            'items' => $permissions->filter(fn($p) => str_contains(strtolower($p->name), 'investor'))
        ],
        'Tipe Investasi' => [
        ...
        'Transfer Pendapatan' => [
            ...
            'items' => $permissions->filter(fn($p) => str_contains(strtolower($p->name), 'transfer') || str_contains(strtolower($p->name), 'excel'))
        ],
    ];
