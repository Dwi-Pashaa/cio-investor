        ...
        <div class="card-body">
            <form action="{{ route('transfer.update', ['id' => $transfers->id]) }}" method="POST">
                ...
                <div class="row">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="investors_id" id="investors_id" class="form-control @error('investors_id') is-invalid @enderror">
                                ...
                                @foreach ($investors as $ivt)
                                    <option value="{{ $ivt->id }}" {{ $transfers->investors_id == $ivt->id ? 'selected' : '' }}>{{ $ivt->name }}</option>
                                @endforeach
                            </select>
                            @error('investors_id')
                    ...
                    <div class="col-md-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="amount" id="amount" class="form-control @error('amount') is-invalid @enderror" value="{{ $transfers->amount }}">
                            @error('amount')
                                <span class="invalid-feedback">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="payment_method" id="payment_method" class="form-control @error('payment_method') is-invalid @enderror">
                                ...
                                @foreach ($banks as $bnk)
                                    <option value="{{ $bnk->name }}" {{ $transfers->payment_method == $bnk->name ? 'selected' : '' }}>{{ $bnk->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="date" name="transfer_date" id="transfer_date" class="form-control @error('transfer_date') is-invalid @enderror" value="{{ $transfers->transfer_date }}">
                            @error('transfer_date')
                                <span class="invalid-feedback">
                                    {{ $message }}
                                </span>
                    ...
                    <div class="col-md-12">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="notes" id="notes" class="form-control @error('notes') is-invalid @enderror" value="{{ $transfers->notes }}">
                            @error('notes')
                                <span class="invalid-feedback">
                                    {{ $message }}
                                </span>
                ...
                <div class="mt-3">
                    ...
                    <button type="submit" class="btn btn-primary float-end">Transfer Ulang</button>
                </div>
            </form>
        </div>
    </div>
